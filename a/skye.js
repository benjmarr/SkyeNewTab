...
var bn = Array(213, 214, 215);
var iud = "Monday 6<sup>th</sup> March, 2017";
var bo = function() {
...
if (sbi === bn[0]) {
  bii("EvKBHBGgaUo", "Jonatan Pie", "r3dmax");
} else if (sbi === bn[1]) {
  bii("UB8-yJNkvVc", "Martin Reisch", "safesolvent");
} else if (sbi === bn[2]) {
  bii("kGSapVfg8Kw", "Kalen Emsley", "kalenemsley");
};
