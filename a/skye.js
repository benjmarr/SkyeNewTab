...
var bn = Array(228, 229, 230);
var iud = "Saturday 20<sup>th</sup> May, 2017";
var bo = function() {
...
if (sbi === bn[0]) {
  bii("8EmcqWtYmU0", "Jonatan Pie", "r3dmax");
} else if (sbi === bn[1]) {
  bii("dz8I-aX-U7Q", "Dmitri Popov", "dmpop");
} else if (sbi === bn[2]) {
  bii("bYFKN82uwOw", "John Paul Summers", "jpthedp");
};
