...
var iud = "Saturday 4<sup>nd</sup> November, 2017";
var bo = function() {
...
if (sbi === bn[0]) {
  bii("Yy4kDZg8pIU", "David Talley", "davidtalley");
} else if (sbi === bn[1]) {
  bii("3Ub-gXhLE6Y", "Steven Hanna", "stevenhanna");
} else if (sbi === bn[2]) {
  bii("daArlleh6b8", "Bryan Minear", "bryanminear");
} else if (sbi === bn[3]) {
