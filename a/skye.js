...
var bn = Array(216, 217, 218);
var iud = "Monday 20<sup>th</sup> March, 2017";
var bo = function() {
...
if (sbi === bn[0]) {
  bii("JOfTqNlkIHU", "Jamie Street", "jamie452");
} else if (sbi === bn[1]) {
  bii("-hI5dX2ObAs", "NASA", "nasa");
} else if (sbi === bn[2]) {
  bii("/-e_njRV9hRE", "Felipe Santana", "felipesantana");
};
